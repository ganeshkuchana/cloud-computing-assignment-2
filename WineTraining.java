...
public class WineTraining {
    ...
    public static void main(String[] args) throws IOException {
        ...
        DecisionTreeClassifier svmClassifier = new DecisionTreeClassifier()
                .setLabelCol("quality")
                .setFeaturesCol("features");
        DecisionTreeClassificationModel trainedSvmModel = svmClassifier.fit(trainingData);
        ...
        // Save the model
        trainedSvmModel.write().overwrite().save("file:///home/ec2-user/dtc");
    }
}