...
spark_session = SparkSession.builder.appName("Decision Tree Inference").getOrCreate()
dt_model = DecisionTreeClassificationModel.load("dtc")
...
def predict_quality():
    ...
    prediction_results = dt_model.transform(validation_data)
