...
spark = SparkSession.builder.appName("Decision Tree Training").getOrCreate()
...
dt_classifier = DecisionTreeClassifier(labelCol="quality", featuresCol="features")
trained_model = dt_classifier.fit(training)
...
trained_model.save("file:///home/ec2-user/dtc")
